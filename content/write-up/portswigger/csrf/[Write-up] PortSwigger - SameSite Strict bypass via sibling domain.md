...
> ![image.png](/writeup/portswigger/csrf/09/1.png)
...
![image.png](/writeup/portswigger/csrf/09/2.png)

이 로그인 기능은 아이디가 틀릴 경우 입력한 `username` 값을 응답 HTML에 그대로 반사하며, 태그를 넣으면 태그로 해석된다.

![image.png](/writeup/portswigger/csrf/09/3.png)
...
![image.png](/writeup/portswigger/csrf/09/4.png)
