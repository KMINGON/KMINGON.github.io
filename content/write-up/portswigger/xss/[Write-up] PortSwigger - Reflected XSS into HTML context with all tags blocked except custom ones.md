...
> ![image.png](/writeup/portswigger/xss/15/1.png)
...
![image.png](/writeup/portswigger/xss/15/2.png)
...
![image.png](/writeup/portswigger/xss/15/3.png)

익스플로잇을 전달하면 쿠키가 `alert()`로 출력되며 문제가 해결된다.

![image.png](/writeup/portswigger/xss/15/4.png)
