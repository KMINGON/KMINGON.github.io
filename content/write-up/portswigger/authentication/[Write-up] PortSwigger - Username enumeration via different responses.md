...
> ![image.png](/writeup/portswigger/authentication/01/1.png)
...
![image.png](/writeup/portswigger/authentication/01/2.png)
...
![image.png](/writeup/portswigger/authentication/01/3.png)

`7777777`에서만 응답이 달라진다(로그인 성공 리다이렉트). 확인한 `austin:7777777`으로 로그인하면 문제가 해결된다.

![image.png](/writeup/portswigger/authentication/01/4.png)
