...
> ![image.png](/writeup/portswigger/authentication/02/1.png)
...
![image.png](/writeup/portswigger/authentication/02/2.png)

여기서 2단계 인증을 진행하지 않고 계정 페이지(`/my-account`)로 바로 이동을 시도해 본다. 그런데 **2FA를 거치지 않았는데도 계정 페이지가 정상적으로 열린다.**

![image.png](/writeup/portswigger/authentication/02/3.png)
...
![image.png](/writeup/portswigger/authentication/02/4.png)
