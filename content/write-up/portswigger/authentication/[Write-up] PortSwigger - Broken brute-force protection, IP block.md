...
> ![image.png](/writeup/portswigger/authentication/06/1.png)
...
![image.png](/writeup/portswigger/authentication/06/2.png)

확인한 `carlos:michelle`로 로그인하면 문제가 해결된다.

![image.png](/writeup/portswigger/authentication/06/3.png)
