...
> ![image.png](/writeup/portswigger/access-control/02/1.png)
...
![image.png](/writeup/portswigger/access-control/02/2.png)

`carlos` 사용자를 삭제하면 문제가 해결된다.

![image.png](/writeup/portswigger/access-control/02/3.png)
