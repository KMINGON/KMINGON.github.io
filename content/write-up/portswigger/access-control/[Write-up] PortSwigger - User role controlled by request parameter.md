...
> ![image.png](/writeup/portswigger/access-control/03/1.png)
...
![image.png](/writeup/portswigger/access-control/03/2.png)

관리자 패널이 정상적으로 열린다. `carlos` 사용자를 삭제하면 문제가 해결된다.

![image.png](/writeup/portswigger/access-control/03/3.png)
