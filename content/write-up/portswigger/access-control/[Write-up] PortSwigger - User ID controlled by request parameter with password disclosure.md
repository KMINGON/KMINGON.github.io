...
> ![image.png](/writeup/portswigger/access-control/08/1.png)
...
![image.png](/writeup/portswigger/access-control/08/2.png)

`carlos` 사용자를 삭제하면 문제가 해결된다.

![image.png](/writeup/portswigger/access-control/08/3.png)
