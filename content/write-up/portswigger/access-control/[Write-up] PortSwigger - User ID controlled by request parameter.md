...
> ![image.png](/writeup/portswigger/access-control/05/1.png)
...
![image.png](/writeup/portswigger/access-control/05/2.png)
...
![image.png](/writeup/portswigger/access-control/05/3.png)

`carlos`의 계정 페이지가 열리며 API Key가 노출된다. 이 값을 제출하면 문제가 해결된다.

![image.png](/writeup/portswigger/access-control/05/4.png)
