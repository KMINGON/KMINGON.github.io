...
> ![image.png](/writeup/portswigger/access-control/01/1.png)
...
![image.png](/writeup/portswigger/access-control/01/2.png)

패널에서 `carlos` 사용자를 삭제하면 문제가 해결된다.

![image.png](/writeup/portswigger/access-control/01/3.png)
