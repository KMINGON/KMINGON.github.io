...
draft = false
title = '[Review] KakaoTalk 1-click account hijacking 분석 (CVE-2023-51219)'
summary = "기본적인 안드로이드 컴포넌트 권한 설정과 웹 프로토콜의 검증 누락이 어떻게 거대한 익스플로잇 체인을 형성하는지 분석"
toc = true
tags = ["KakaoTalk", "XSS", "DOM-Based", "WebView", "Deeplink", "Authentication"]
url = '/review/review-kakaotalk-1-click-account-hijacking-분석-cve-2023-51219/'
+++
---
