...
url = '/analysis/analysis-csp-nonce-우회-방법-분석/'
+++
...
보안 강화를 위해 표준 권고대로 Response Header에서 CSP를 설정하고 매번 새로운 nonce를 발급한다면, 공격자가 nonce 값을 알아내는 것은 정말 불가능할까? 
